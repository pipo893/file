...
export const QuizResults: React.FC<QuizResultsProps> = ({ data, userAnswers, timeSpent, onRetry, onRetryWrong, onNewFile }) => {
              ...
              <div key={q.id} className="p-6 question-break-avoid">
                <div className="flex gap-3 mb-3">
                   ...
                   <div className="flex-1">
                     <p className="text-slate-900 dark:text-slate-100 font-medium mb-4">{q.text}</p>
                     ...
                     <div className="space-y-2">
                       {q.options.map(opt => {
                         ...
                         const isSelected = opt.key === userChoice;
